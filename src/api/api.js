export const data = [
  ...
  },
  {
    id: 3,
    name: 'Main Dishs',
    description: 'there is so many main dish recipes',
    image: '/images/main.jpg',
    items: [
      {
        image: '/images/5main.jpg',
        id: 1,
        category: 'Main Dishs',
        timeForDone: '45 minutes',
        description: 'Delicious pasta with creamy sauce',
        ingredients: ['pasta', 'heavy cream', 'Parmesan cheese', 'garlic', 'olive oil'],
        recipe:
      ...
      {
        image: '/images/1-dish.jpg',
        id: 2,
        category: 'Main Dishs',
        timeForDone: '1 hour',
        description: 'Juicy roasted chicken with crispy skin',
        ingredients: ['whole chicken', 'butter', 'garlic', 'lemon', 'salt', 'black pepper'],
        recipe:
  ...
  },
  {
    id: 4,
    name: 'Side Dishs',
    description: 'there is so many side dish recipes',
    image: '/images/side-dish.jpg',
    items: [
      {
        image: '/images/4-side.jpg',
        id: 1,
        category: 'Side Dishs',
